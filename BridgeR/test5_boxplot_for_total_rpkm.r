...
png(filename='Boxplot_Comparison_of_Rel_RPKM_siStealth_vs_siPUM1_totalRPKM.png',width = 1300, height = 1000)
...
png(filename='Boxplot_Comparison_of_Rel_RPKM_siStealth_vs_siCTRL_totalRPKM.png',width = 1300, height = 1000)
