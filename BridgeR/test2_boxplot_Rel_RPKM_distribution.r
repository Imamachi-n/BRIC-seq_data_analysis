...
png(filename='Comparison_of_Rel_RPKM_siStealth_vs_siPUM1_log10_total_percentile.png',width = 900, height = 900)
...
png(filename='Comparison_of_Rel_RPKM_siStealth_vs_siPUM1_log10_compatible_percentile.png',width = 900, height = 900)
...
png(filename='Comparison_of_Rel_RPKM_siStealth_vs_siCTRL_log10_total_percentile.png',width = 900, height = 900)
...
png(filename='Comparison_of_Rel_RPKM_siStealth_vs_siCTRL_log10_compatible_percentile.png',width = 900, height = 900)
